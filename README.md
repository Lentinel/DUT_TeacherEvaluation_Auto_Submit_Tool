...
目前实现的功能是：进入每位老师的问卷页面后，点击页面左下角按钮实现一键自动填写并提交。暂时没有一键提交所有教师的问卷的功能，可能以后会加吧。

有同学反馈，1 分钟疑似只能交最多 5 份问卷，超出后教务系统会报错，大家使用时请慢点交。

由于大工教务系统的 URL 的路由规则非法，脚本会在进入教务系统首页就启动，目前无解，不影响脚本功能。

未来**问卷系统**或**问卷题目**可能**出现变化**，如果本工具出现问题，欢迎提 issue。

2025.5.20注：新版代码似乎会导致莫名其妙的 500 错误，现已回退上个版本。至于为什么会出问题等我有空再好好看看，现在没啥时间= =

***

脚本分两版，请对照自己的页面，如无下拉评分，则使用后缀为_no_score的版本
...
打开开发者模式后，如图操作打开console，把脚本的 JavaScript 代码粘贴进去，回车运行:

![Pix_26.01.08_11.51.54](./image/Pix_26.01.08_11.51.54.png)
![Pix_26.01.08_11.54.03](./image/Pix_26.01.08_11.54.03.png)